...
@push('css-top')
    ...
    <link rel="stylesheet" href="{{ asset('assets/backend/plugins/bootstrap-slider/css/bootstrap-slider.min.css') }}">
@endpush
@section('content')
...
@push('js-bottom')
    ...
    <script src="{{ asset('assets/backend/plugins/bootstrap-slider/bootstrap-slider.min.js') }}"></script>
