        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-previewTitle">Modal title</h5>
...
@push('js-bottom')
    ...
    <script>
        ...
        $(document).on('click', '.paginate-link', function(e){
            ...
            $.ajax({
                url:"http://comic.test/console/chapter/list?page="+page,
                method : "POST",
                data : {
                    search : search,
                    comic_id : comic_id
                ...
                success:function(reply){
                    chapter_data(reply.data, reply.links, page)
                }
            });
        });
        ...
        function chapter_filter(){
            ...
            $.ajax({
                ...
                success : function(reply){
                    chapter_data(reply.data, reply.links, 1)
                }
            });  
        }

        function chapter_data(data, links, page){
                ...
                $('#chapter-container').append(`
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" class="chapter-grabber" data-id="`+v.id+`"><i class="fas fa-hand-rock"></i></a>
                        </td>
                    </tr>
                `);
            });
