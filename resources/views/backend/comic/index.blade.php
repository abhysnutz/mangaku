            ...
            $.each(data, function(k,v){
                ...
                $('#comic-container').append(`
                    <tr>
                        ...
                        <td>
                            <a href="#" class="mr-2 comic-view" data-toggle="modal" data-target="#modal-preview" data-id="`+v.id+`"><i class="far fa-eye"></i></a>
                            ...
                            <a href="#" class="comic-grabber" data-id="`+v.id+`"><i class="fas fa-hand-rock"></i></a>
                        </td>
                    </tr>
                `);
            });
